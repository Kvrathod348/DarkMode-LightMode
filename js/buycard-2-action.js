...
function first() {
    ...
    imgChange.src = "../images/best-selling-action/card-2/1.png"
}

function second() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-2/2.png"
}

function third() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-2/3.png"
}

function fourth() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-2/4.png"
}
