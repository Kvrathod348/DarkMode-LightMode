...
function first() {
    ...
    imgChange.src = "../images/best-selling-action/card-3/2.png"
}
...
function third() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-3/4.png"
}

function fourth() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-3/5.png"
}

function fifth() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-3/6.png"
}
