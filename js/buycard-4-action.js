...
function first() {
    ...
    imgChange.src = "../images/best-selling-action/card-4/1.png"
}

function second() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-4/2.png"
}

function third() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-4/3.png"
}

function fourth() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-4/4.png"
}

function fifth() {
    const imgChange = document.getElementById('img-show')
    imgChange.src = "../images/best-selling-action/card-4/5.png"
}
